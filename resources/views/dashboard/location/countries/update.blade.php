<!-- Modal -->
<div class="modal fade" id="editCountry" data-backdrop="static" data-keyboard="false"
     tabindex="-1" aria-labelledby="editCountryLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="editCountryLabel">{{__('words.show_country')}}</h5>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-6 text-center pt-3">
                                    <img src="{{ asset('uploads/default_image.png') }}"
                                        id="flag" class="slider_image image-preview" alt="logo">
                                </div>
                            </div>
                            <hr>
                            <div class="form-row">
