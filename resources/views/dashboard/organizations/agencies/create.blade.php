<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="storeAgency" data-backdrop="static" data-keyboard="false"
     tabindex="-1" aria-labelledby="storeAgencyLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="storeAgencyLabel">{{__('words.new_agency')}}</h5>
                <button type="button" class="close {{App::isLocale('ar') ? 'modal-x-sign' : ''}}" data-dismiss="modal"
                        aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="POST" action="{{route('agencies.store')}}" id="store_form" autocomplete="off" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="year_founded"
                                           ...
                                           value="{{ old('year_founded') }}" placeholder="">
