<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="editAgency" data-backdrop="static" data-keyboard="false"
     tabindex="-1" aria-labelledby="editAgencyLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="editAgencyLabel">{{__('words.show_agency')}}</h5>
