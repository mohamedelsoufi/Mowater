<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="editBroker" data-backdrop="static" data-keyboard="false"
     tabindex="-1" aria-labelledby="editBrokerLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="editBrokerLabel">{{__('words.show_broker')}}</h5>
            ...
            <form method="POST" action="" id="update_form" autocomplete="off" enctype="multipart/form-data">
                @method('put')
                @csrf
                <input type="hidden" name="id" id="broker_id" value="">
                        ...
                        <div class="basic-form">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="requirements_ar"
                                              class="form-control ckeditor @error('requirements_ar') is-invalid @enderror">{{ old('requirements_ar') }}</textarea>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="requirements_en"
                                              class="form-control ckeditor @error('requirements_en') is-invalid @enderror">{{ old('requirements_en') }}</textarea>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    <label>{{__('words.record_number')}}</label>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" id="active" name="active" value="0"
                                                   type="checkbox">
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" id="reservation_active"
                                                   name="reservation_active" value="0"
                                                   type="checkbox">
                                            <label class="form-check-label">
