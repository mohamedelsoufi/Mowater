<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="editCarShowroom" data-backdrop="static" data-keyboard="false"
     tabindex="-1" aria-labelledby="editCarShowroomLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="editCarShowroomLabel">{{__('words.show_car_showrooms')}}</h5>
            ...
            <form method="POST" action="" id="update_form" autocomplete="off" enctype="multipart/form-data">
                @method('put')
                @csrf
                <input type="hidden" name="id" id="car_showroom_id" value="">
