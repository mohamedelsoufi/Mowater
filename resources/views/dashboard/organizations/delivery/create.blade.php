<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="storeDelivery" data-backdrop="static" data-keyboard="false"
     tabindex="-1" aria-labelledby="storeDeliveryLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="storeDeliveryLabel">{{__('words.new_delivery')}}</h5>
                <button type="button" class="close {{App::isLocale('ar') ? 'modal-x-sign' : ''}}" data-dismiss="modal"
                        aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="POST" action="{{route('delivery.store')}}" id="store_form" autocomplete="off"
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="name_ar"
                                           ...
                                           placeholder="{{__('words.name_ar')}} " value="{{ old('name_ar') }}">
                                    @error('name_ar')
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 manufacturing_year">
