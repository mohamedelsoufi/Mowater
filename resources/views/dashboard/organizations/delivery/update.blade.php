<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="editDelivery" data-backdrop="static" data-keyboard="false"
     tabindex="-1" aria-labelledby="editDeliveryLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="editDeliveryLabel">{{__('words.show_delivery')}}</h5>
                        ...
                        <div class="basic-form">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4 ">
                                    ...
                                    <input class="form-control birth_date" type="date" id="birth_date"
                                           name="birth_date">
                                    @error('birth_date')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
