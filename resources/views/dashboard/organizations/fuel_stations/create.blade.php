<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="storeFuelStation" data-backdrop="static" data-keyboard="false"
     tabindex="-1" aria-labelledby="storeFuelStationLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="storeFuelStationLabel">{{__('words.new_fuel_station')}}</h5>
                <button type="button" class="close {{App::isLocale('ar') ? 'modal-x-sign' : ''}}" data-dismiss="modal"
                        aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="POST" action="{{route('fuel-stations.store')}}" id="store_form" autocomplete="off"
                        ...
                        <div class="basic-form">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input type="checkbox" name="fuel_types[]" value="Gasoline_91">
                                </div>

                                 <div class="col-md-3">
                                    <label for="Gasoline_95">{{__('words.Gasoline_95')}}</label>
                                    <input type="checkbox" name="fuel_types[]" value="Gasoline_95">
                                </div>

                                <div class="col-md-3">
                                    <label for="Gasoline_98">{{__('words.Gasoline_98')}}</label>
                                    <input type="checkbox" name="fuel_types[]" value="Gasoline_98">
                                </div>
