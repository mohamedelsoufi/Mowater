<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="storeGarage" data-backdrop="static" data-keyboard="false"
     tabindex="-1" aria-labelledby="storeGarageLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="storeGarageLabel">{{__('words.new_garage')}}</h5>
                <button type="button" class="close {{App::isLocale('ar') ? 'modal-x-sign' : ''}}" data-dismiss="modal"
                        aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="POST" action="{{route('garages.store')}}" id="store_form" autocomplete="off" enctype="multipart/form-data">
                @csrf
