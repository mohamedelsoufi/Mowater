<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="editGarage" data-backdrop="static" data-keyboard="false"
     tabindex="-1" aria-labelledby="editGarageLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="editGarageLabel">{{__('words.show_garage')}}</h5>
            ...
            <form method="POST" action="" id="update_form" autocomplete="off" enctype="multipart/form-data">
                @method('put')
                @csrf
                <input type="hidden" name="id" id="garage_id" value="">
