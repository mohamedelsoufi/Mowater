<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="editRentalOffice" data-backdrop="static" data-keyboard="false"
     tabindex="-1" aria-labelledby="editRentalOfficeLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="editRentalOfficeLabel">{{__('words.show_rental_office')}}</h5>
            ...
            <form method="POST" action="" id="update_form" autocomplete="off" enctype="multipart/form-data">
                @method('put')
                @csrf
                <input type="hidden" name="id" id="rental_offices_id" value="">
