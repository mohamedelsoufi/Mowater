<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="editScrap" data-backdrop="static" data-keyboard="false"
     tabindex="-1" aria-labelledby="editScrapLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="editScrapLabel">{{__('words.show_scrap')}}</h5>
            ...
            <form method="POST" action="" id="update_form" autocomplete="off" enctype="multipart/form-data">
                @method('put')
                @csrf
                <input type="hidden" name="id" id="Scrap_id" value="">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="year_founded" id="year_founded"
                                           class="form-control yearpicker @error('year_founded') is-invalid @enderror"
