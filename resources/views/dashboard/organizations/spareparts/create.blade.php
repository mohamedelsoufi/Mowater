<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="storeSparepart" data-backdrop="static" data-keyboard="false"
     tabindex="-1" aria-labelledby="storeSparepartLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="storeSparepartLabel">{{__('words.new_sparepart')}}</h5>
                <button type="button" class="close {{App::isLocale('ar') ? 'modal-x-sign' : ''}}" data-dismiss="modal"
                        aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="POST" action="{{route('spareparts.store')}}" id="store_form" autocomplete="off"
                ...
                <div class="modal-body">
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6 year_founded">
