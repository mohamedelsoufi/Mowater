<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="editSparepart" data-backdrop="static" data-keyboard="false"
     tabindex="-1" aria-labelledby="editSparepart Label" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="editSparepartLabel">{{__('words.show_spare_part')}}</h5>
