<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="editSpecialNumberOrganization" data-backdrop="static" data-keyboard="false"
     tabindex="-1" aria-labelledby="editSpecialNumberOrganizationLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="editSpecialNumberOrganizationLabel">{{__('words.show_special_number_organization')}}</h5>
            ...
            <form method="POST" action="" id="update_form" autocomplete="off" enctype="multipart/form-data">
                @method('put')
                @csrf
                <input type="hidden" name="id" id="special_number_organization_id" value="">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="tax_number" id="tax_number"
                                           class="form-control @error('tax_number') is-invalid @enderror" placeholder="{{__('words.tax_number')}}">
                                    @error('tax_number')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" id="reservation_active" name="reservation_active" value="0"
                                               type="checkbox">
                                        <label class="form-check-label">
                                ...
                                <div class="form-group col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" id="delivery_active" name="delivery_active" value="0"
                                               type="checkbox">
                                        <label class="form-check-label">
