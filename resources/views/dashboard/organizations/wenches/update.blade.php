<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="editWench" data-backdrop="static" data-keyboard="false"
     tabindex="-1" aria-labelledby="editWenchLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="editWenchLabel">{{__('words.show_wench')}}</h5>
            ...
            <form method="POST" action="" id="update_form" autocomplete="off" enctype="multipart/form-data">
                @method('put')
                @csrf
                <input type="hidden" name="id" id="wench_id" value="">
                        ...
                        <div class="basic-form">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="wench_type" id="wench_type"
