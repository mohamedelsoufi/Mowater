<!-- Modal -->
<div class="modal fade" id="editCarClass" data-backdrop="static" data-keyboard="false"
     tabindex="-1" aria-labelledby="editCarClassLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="editCarClassLabel">{{__('words.show_car_model')}}</h5>
            ...
            <form method="POST" action="" id="update_form" autocomplete="off">
                @method('put')
                @csrf
                <input type="hidden" name="id" id="car_class_id" value="">
