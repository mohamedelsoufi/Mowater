                          ...
                          <form action="{{route('organization.branch.update' , $branch->id)}}" method = "POST">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="country_id"
                                        ...
                                        @foreach($countries as $country)
                                            <option value="{{$country->id}}" {{$branch->area && $branch->area->city && $branch->area->city->country_id == $country->id  ? 'selected' : '' }}  >{{$country->name}}</option>
                                        @endforeach
                                    </select>
                                    @error('country_id')
                              ...
                              <div class="row">
                                  <div class="form-group col-md-4">
                                      ...
                                      <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ $branch->organization_users && $branch->organization_users->first() ?  $branch->organization_users->first()->email : '' }}" placeholder="{{__('words.email')}}">
                                      @error('email')
                                      <span class="invalid-feedback" role="alert">
                                              <strong>{{ $message }}</strong>
                                          </span>
                                  ...
                                  <div class="form-group col-md-4">
                                      ...
                                      <input type="text" name="user_name" class="form-control @error('name_en') is-invalid @enderror" value="{{ $branch->organization_users && $branch->organization_users->first() ?  $branch->organization_users->first()->user_name : '' }}" placeholder="{{__('words.user_name')}}">
                                  ...
                                  <div class="form-group col-md-4">
                                      ...
                                      <input autocomplete="false" type="password" name="password" class="form-control @error('password') is-invalid @enderror" placeholder="{{__('words.password')}}">
                                      @error('password')
                                      <span class="invalid-feedback" role="alert">
                                              <strong>{{ $message }}</strong>
                                          </span>
