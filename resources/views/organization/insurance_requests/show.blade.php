            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <h4>{{__('words.insurance_requests')}}</h4>
                    </div>
                </div>
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{__('words.insurance_request')}}</li>
                    </ol>
                </div>
                            ...
                            <div class="profile-personal-info">
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="form-row">
                                            <h5 class="f-w-500">{{__('words.name')}}<span
                                                    class="f-w-500">:</span>
                                            </h5>
                                            <div class="col-9"><span>{{$insurance_request->name}}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="form-row">
                                            <h5 class="f-w-500">{{__('words.phone')}}<span
                                                    class="f-w-500">:</span></h5>
                                            <div class="col-9"><span>{{$insurance_request->phone}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-9"><span>{{$insurance_request->address}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="col-9"><span>{{$insurance_request->car_model}}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="form-row">
                                            ...
                                            <div class="col-9">
                                                <span>{{$insurance_request->manufacturing_year}}</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 mb-4">
                                        <div class="form-row">
                                            ...
                                            <div class="col-9">
                                                <span>{{\App\Models\Brand::find($insurance_request->brand_id)->name}}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <div class="form-row">
                                            ...
                                            <div class="col-9"><span>{{$insurance_request->engine_size}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="col-md-6 mb-4">
                                        <div class="form-row">
                                            ...
                                            <div class="col-9"><span>{{$insurance_request->insurance_price}}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 mb-4">
                                        <div class="form-row">
                                            ...
                                            <div class="col-9">
                                                <span>{{__('words.'.$insurance_request->pivot->status)}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    @if($insurance_request->pivot->status !='pending')
                                    ...
                                    @else
                                        <div class="modal-footer">
                                            <a
                                                href="{{route('organization.insurance_requests.update',$insurance_request->id)}}"
                                                class="btn btn-outline-info">{{__('words.send_reply')}}</a>
