                    ...
                    <div class="row no-gutters">
                        <div class="col-xl-12">
                            <div class="auth-form">
                                ...
                                <h4 class="text-center mb-4">{{__('words.sign_in_your_account_org')}}</h4>
                                <form action="{{route('organization.authenticate')}}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control @error('password') is-invalid @enderror"
                                               autocomplete="new-password"  name="password" autocomplete="current-password">
                                        @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                        ...
                                        <div class="form-group">
                                            <div class="form-check ml-2">
                                                ...
                                                <label class="form-check-label"
                                                       for="basic_checkbox_1">{{__('words.remember_me')}}</label>
                                            </div>
                                        </div>
{{--                                        <div class="form-group">--}}
...
{{--                                        </div>--}}
                                    ...
                                    <div class="text-center">
                                        <button type="submit"
                                                class="btn btn-primary btn-block">{{__('words.sign_in')}}</button>
                                    </div>
                                </form>
{{--                                <div class="new-account mt-3">--}}
{{--                                    <p>{{__('words.dont_have_account')}} <a class="text-primary"--}}
{{--                                                                            href="./page-register.html">{{__('words.sign_up')}}</a>--}}
{{--                                    </p>--}}
{{--                                </div>--}}
                            </div>
                        </div>
