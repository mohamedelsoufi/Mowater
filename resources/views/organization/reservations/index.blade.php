                                ...
                                <table id="example" class="display" style="min-width: 845px">
                                    ...
                                    @foreach($reservations as $reservation)
                                        <tr class="text-center">
                                            ...
                                            @else
                                                <td>{{__('words.not_mentioned')}}</td>
                                            @endif
                                            <td>{{$reservation->price ?$reservation->price :__('words.not_mentioned') }}</td>
                                            <td>{{$reservation->date ?$reservation->date :$reservation->created_at->toDateString() }}</td>
                                            <td>{{__('words.'.$reservation->status)}}</td>
                                            <td>
                                                {{-- <a href="{{route('organization.reservations.edit',$reservation->id)}}"
