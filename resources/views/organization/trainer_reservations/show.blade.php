                                                        ...
                                                        <div class="col-md-6 mb-4">
                                                            ...
                                                            <div class="col-md-6">
                                                                <span>{{__('words.'.$reservation->status)}}</span><a
                                                                    href="{{route('organization.trainer_reservations.edit',$reservation->id)}}"
...
@section('scripts')
    <script type="text/javascript">
        ...
        function get_product_data(id) {
            var url = "{{route('organization.trainer_reservations.edit' , ':id')}}";
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status == true) {
                        ...
                        let update = "{{route('organization.trainer_reservations.edit' , ':id')}}";
