<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="editOrgUser" data-backdrop="static" data-keyboard="false"
     tabindex="-1" aria-labelledby="editOrgUserLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="editOrgUserLabel">{{__('words.edit_user')}} </h5>
