<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="editVerification" data-backdrop="static" data-keyboard="false"
     tabindex="-1" aria-labelledby="editVerificationLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-primary" id="editVerificationLabel">{{__('words.show_verifications')}}</h5>
            ...
            <form method="POST" action="" id="update_form" autocomplete="off" enctype="multipart/form-data">
                @method('put')
                @csrf
                <input type="hidden" name="id" id="verification_id" value="">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="status" id="status"
                                        ...
                                        <option value="available">{{__('words.available_prop')}}</option>
                                        <option value="not_available">{{__('words.not_available_prop')}}</option>
                                    </select>
                                    @error('status')
